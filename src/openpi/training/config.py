...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi0_xhand_tactile_structured_raw_dual_ae_arm_future_hand_mask_tactile_refine",
        model=pi0_config.Pi0LatentFlowConfig(
            action_horizon=32,
            action_dim=32,
            paligemma_variant="gemma_2b",
            ...
            arm_action_dim=6,
            hand_action_dim=12,
            tactile_refiner_enabled=True,
            tactile_refiner_layers=2,
            tactile_refiner_width=256,
            tactile_refiner_heads=4,
            tactile_refiner_mlp_dim=1024,
            hand_synergy_dim=4,
            hand_synergy_loss_weight=0.03,
            tactile_refiner_delta_loss_weight=0.0001,
            tactile_refiner_gate_bias=-2.0,
            tactile_refiner_delta_scale=0.1,
        ),
        data=LeRobotXHandTactileFlowDataConfig(
            repo_id="grasp_pipette_and_press_button",
            state_delta_timestamps=tuple(
    ...
    TrainConfig(
        name="pi0_xhand_tactile_structured_adaptive_patch_raw_dual_ae_arm_future_hand_mask_tactile_refine",
        model=pi0_config.Pi0LatentFlowConfig(
            action_horizon=32,
            action_dim=32,
            paligemma_variant="gemma_2b",
    ...
    TrainConfig(
        name="pi0_xhand_tactile_action_aware_single_ae",
        model=pi0_config.Pi0FutureTactileConfig(
            action_horizon=32,
            action_dim=32,
            paligemma_variant="gemma_2b",
