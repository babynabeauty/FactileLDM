...
class Observation(Generic[ArrayT]):
    ...
    # Optional future 3D scene-flow points, e.g. [xyz, target_xyz, flow_xyz, class_id].
    scene_flow: at.Float[ArrayT, "*b p d"] | None = None
...
def preprocess_observation(
    ...
    *,
    ...
    return Observation(
        ...
        scene_flow=observation.scene_flow,
